...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '8018332397:AAESXrCBWibwYKRS_tAYKdla3Wpdh6pcnck'
OWNER_ID = 6434780221 # 👈 Put your real Telegram user ID here
...
async def generate_special_key_format(update: Update, context: CallbackContext):
    ...
    await update.message.reply_text(
        ...
        f"⚠️ *This key provides enhanced attack capabilities when you fucking bgmi mommy!*",
        parse_mode='Markdown'
    )
    return ConversationHandler.END
...
async def rules(update: Update, context: CallbackContext):
    ...
    rules_text = (
        ...
        "JO BHI bgmi KI MAKI CHUT PHAADKE SS DEGA USSE EXTRA KEY DUNGA.\n\n"
    )
